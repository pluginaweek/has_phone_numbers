...
desc 'Test the acts_as_phoneable plugin.'
...
desc 'Generate documentation for the acts_as_phoneable plugin.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ActsAsPhoneable'
...
spec = Gem::Specification.new do |s|
  ...
  s.require_path    = 'lib'
  s.autorequire     = 'acts_as_phoneable'
  s.has_rdoc        = true
